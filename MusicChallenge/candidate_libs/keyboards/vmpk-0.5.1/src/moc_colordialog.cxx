...
static const char qt_meta_stringdata_ColorDialog[] = {
    "ColorDialog\0\0i\0loadPalette(int)\0"
    "onAnyColorWidgetClicked(int)\0"
    "resetCurrentPalette()\0"
};
...
void ColorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->loadPalette((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onAnyColorWidgetClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->resetCurrentPalette(); break;
        default: ;
        }
    }
}
