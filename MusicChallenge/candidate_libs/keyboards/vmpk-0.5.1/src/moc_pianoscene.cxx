...
static const char qt_meta_stringdata_PianoScene[] = {
    "PianoScene\0\0n,v\0noteOn(int,int)\0"
    "noteOff(int,int)\0"
};
...
const QMetaObjectExtraData PianoScene::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PianoScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_PianoScene,
      qt_meta_data_PianoScene, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PianoScene::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PianoScene))
...
// SIGNAL 0
void PianoScene::noteOn(int _t1, int _t2)
{
...
// SIGNAL 1
void PianoScene::noteOff(int _t1, int _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
