package com.gui_elements
{
	...
	public class  GradientButton extends Sprite
	{
		...
		public function GradientButton(txt:String, w:uint=40, h:uint=30, r:uint=5 ,color1:uint=0x04618d, color2:uint=0x379EE0)
		{
			_color1 = color1;
			_color2 = color2;
		...
		protected function init(e:Event = null):void
		{
			...
			//this.addEventListener(MouseEvent.CLICK, startAnimatingGradient);
		}
		...
		public function drawGradient():void 
		{
			...
			m.createGradientBox(_w, _h, Math.PI/3.0, 0, 0);
			//m.createGradientBox(0, 0, 0, 0, 0);
		...
		protected function startAnimatingGradient(e:MouseEvent = null):void
		{
			TweenMax.to(colors, 1, { hexColors: { left:_color2, right:_color1 }, onUpdate:drawGradient } );
			//resetAnimatingGradient();
		}
		
		protected function resetAnimatingGradient(e:MouseEvent = null):void
		{
			TweenMax.to(colors, 1, {hexColors:{left:_color1, right:_color2}, onUpdate:drawGradient});
		}
