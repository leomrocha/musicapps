package com.leopanigo.audio_processing
{
	...
	public class NoteMapper
	{
		...
		public  static const LEN_NOTES:uint = 100;
			...
			public function updateMidiNote(midiID:uint):void
			{
				if (midiID > 12 && midiID-12< LEN_NOTES)
				{
					_currPos = midiID - 12;
					_octave = _currPos / 12;
					_currErrorHz = 0;
					_currErrorCents = 0;
					_currNote = NOTES_NAMES[_currPos];
					_currFreq = NOTES_FREQUENCIES[_currPos];
					_currMidiNote = midiID;
			...
			{
				var n:Note = new Note(_currFreq, _currNote, _octave, _currMidiNote, _currErrorCents, _currErrorHz);
				return n;
			}
	}
}