package com.leopanigo.components.screens 
{
	 ...
	 * @author Leo Panigo
	 */
	public class AboutPageScreen extends Sprite 
	{
		...
		private var nameTxt:String = "Music Practice Room";
		private var nameField:TextField;
		
		private var versionTxt:String = " Version  0.1 2012 11 17";
		private var versionField:TextField;
		
		private var logo:Sprite;
		
		private var descriptionTxt:String = "Leo's Music Practice Room is a simple application to track what you play in an instrument  and be able to see where and what mistake you didn. This applicatin will continue growing. You can help making comments and leaving oppinions of what you will like added or modified in the app";
		...
		private var endUserRightsLink:String = "http://leopanigo.net/MusicPracticeRoomEndUserRights";
		private var endUserRightsField:TextField;
		
		private var privacyPolicyTxt:String = "";
		private var privacyPolicyLink:String = "http://leopanigo.net/MusicPracticeRoomEndUserRights";
		private var privacyPolicyField:TextField;
		
		public function AboutPageScreen(w:Number , h:Number) 
		{
