package com.components 
{
	...
	public class MultiFrequencyAutoIntervalDisplay extends Sprite 
	{
		private var _w:uint;
		private var _h:uint;
		...
		private var _vectVect:Vector.<Vector.<Number>>;//vector containing the vectors of the elements to show
		 ...
		 * @param	
		 */
		public function MultiFrequencyAutoIntervalDisplay(w:uint = 640 , h:uint = 480,
													...
													showFreq:Boolean = true, showNote:Boolean =true)
		{
			...
			_vectVect = new Vector.<Vector.<Number>>;
		...
		public function update(notes:Vector.<Note>, tick:Boolean = false ):void
		{
			...
			for (var k:uint = 0; k < notes.length; k++)
			{
				...
				{
					trace("ERROR in MultiFrequencyAutoIntervalDisplay, max and min freauencies not set");
					throw(new Error("ERROR in MultiFrequencyAutoIntervalDisplay, max and min freauencies not set"));
				}
