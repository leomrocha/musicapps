package com.gui_elements 
{
	...
	public class PauseButton extends GradientButton 
	{
		...
		public function PauseButton(w:uint=40, h:uint=30, r:uint=5 ,color1:uint=0x04618d, color2:uint=0x379EE0, markColour:uint = 0xFFFF00) 
		{
		...
		override protected function setProperties():void
		{
			...
			rectangle2.graphics.beginFill(_markColour, 0.7); // choosing the colour for the fill
