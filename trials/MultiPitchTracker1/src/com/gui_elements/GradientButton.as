package com.gui_elements
{
	...
	public class  GradientButton extends Sprite
	{
		...
		protected function setProperties():void
		{
			...
			_txtObject.width = _w *0.9;
			_txtObject.height = 14;
			_txtObject.scaleX = 1;
			_txtObject.scaleY = 1;
			_txtObject.x = _w*0.1;
			_txtObject.y = _h*0.1;
			//_txtObject.maxChars = 8;
			_txtObject.textColor = 0xFFFF44;
			_txtObject.selectable = false;
			//_txtObject.type = TextFieldType.INPUT;
			//_txt = "100 /100";
			_txtObject.text = _txt;
			_txtObject.autoSize = TextFieldAutoSize.CENTER;
