package com.gui_elements.bmp_graphs 
{
	...
	{ // from http://wonderfl.net/c/heMs
        private var _w:uint,//width  with a rate of 11 this should be 512
                    ...
                    _n:int,
					_maxVal:Number = 1.0;
        public function BMPAmplitudGraph(width:uint = 512, height:uint = 211, maxVal:Number=1.0, pointWidth:Number = 2, waveColour:uint = 0xAAffAA, backgroundColour:uint = 0x000000):void{
            _maxVal = maxVal;
			_w = width;
