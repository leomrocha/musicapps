package com.tools.pianito.gui_elements 
{
	...
	public class PlayButtonScreen extends Sprite 
	{
		...
		private function init(e:Event = null):void 
		{
			...
			addChild(background);
			//button
			playButton = new GradientButton("PLAY", stage.stageWidth / 2.0, stage.stageHeight / 10.0, 45);
			playButton.x = stage.stageWidth / 4.0;
			playButton.y = stage.stageHeight / 2.0 - stage.stageHeight / 10.0;
			addChild(playButton);
